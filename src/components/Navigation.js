...
              <React.Fragment>
  ...
  return (
    <div className="mb-3">
    <div style={{"textAlign": "center"}}> Developed with <span role="img"> ❤️ </span> by <a className="link-style"  href="https://www.facebook.com/profile.php?id=100014745070123" target="_blank">QuyVo</a></div>
      <Navbar color="light" light expand="md"> 
        <NavbarBrand className="mx-auto" href="/"><span style={{ fontWeight: "bold"}}>QuyVo</span></NavbarBrand>
